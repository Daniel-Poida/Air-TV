...
Прототип 0.1.4 для Android TV 7.0+ (API 24).
...
Откройте **Air TV → AirDrop** на телевизоре. Отсканируйте QR камерой телефона или откройте адрес `http://IP-телевизора:порт/` в браузере Mac. Адрес, порт и QR видны на экране AirDrop; QR содержит только адрес, без PIN.
